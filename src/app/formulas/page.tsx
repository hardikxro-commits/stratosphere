      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative mb-8">
          <input
            ...
            className="w-full p-3 pl-10 glass-card font-serif text-sm focus:outline-none focus:!border-[#B84A3A] dark:focus:!border-[#D4735E] transition-colors"
          />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {chapters.map((ch) => (
                <Link
                  ...
                  className="p-4 glass-card hover:!border-[#B84A3A] dark:hover:!border-[#D4735E] group transition-all"
                >
